...
namespace ECE
{
  ...
  public class EasyColliderGizmos : MonoBehaviour
  {
    ...
    void Reset()
    {
      // Sets gizmo prefs on reset (when reset is used or the component is added)
      SetGizmoPreferences();
    }
    ...
    private void SetGizmoPreferences()
    {
      ...
      SelectedVertexColor = ECEPreferences.SelectedVertColour;
      SelectedVertexScale = ECEPreferences.SelectedVertScaling;

      HoveredVertexColor = ECEPreferences.HoverVertColour;
      HoveredVertexScale = ECEPreferences.HoverVertScaling;

      OverlapVertexColor = ECEPreferences.OverlapSelectedVertColour;
      OverlapVertexScale = ECEPreferences.OverlapSelectedVertScale;

      DisplayVertexColor = ECEPreferences.DisplayVerticesColour;
      DisplayVertexScale = ECEPreferences.DisplayVerticesScaling;

      UseFixedGizmoScale = ECEPreferences.UseFixedGizmoScale;


      CommonScale = ECEPreferences.CommonScalingMultiplier;

      GizmoType = ECEPreferences.GizmoType;
    }
  }
}
#endif